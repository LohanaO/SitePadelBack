...
<body>
        ...
        <ul class="Menu" id="menu">
            ...
            <li class="menu__item container-submenu ">
                ...
                <ul class="submenu">
                    ...
                    <li class="menu__item"><a href="" class="menu__link">Inscripcion</a>
                    </li>
                    <li class="menu__item"><a href="" class="menu__link">Fixture</a>
                    </li>
                    <li class="menu__item"><a href="" class="menu__link">Ranking</a>
                    </li>
    ...
    <div class="contenedor fondo">
        <div class="contenedor1 margin">
            ...
            <div class="regresar">
                <a  href="subir.html">cargar Foto</a>
                </div>
            <secion class="fotos">
                <div class="contenedor1">
                    ...
                    <div class="thumb">
                        <a href="foto.html">
                            <img src="img/padel5.jpg" alt="">
                        </a>
                    </div>
                    <div class="thumb">
                        <a href="#">
                            <img src="img/padel4.jpg" alt="">
                        </a>
                    </div>

                    <div class="thumb">
                        <a href="#">
                            <img src="img/padel13.jpg" alt="">
                        </a>
                    </div>

                    <div class="thumb">
                        <a href="#">
                            <img src="img/padel9.jpg" alt="">
                        </a>
                    </div>
                    <div class="thumb">
                        <a href="#">
                            <img src="img/padel10.jpg" alt="">
                        </a>
                    </div>
                    <div class="thumb">
                        <a href="#">
                            <img src="img/padel11.jpg" alt="">
                        </a>
                    </div>

                    <div class="thumb">
                        <a href="#">
                            <img src="img/padel12.jpg" alt="">
                        </a>
                    </div>
